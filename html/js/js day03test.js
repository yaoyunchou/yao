...
! function() {
    ...
    a.v = "1.2", b = document, c = "getElementById", d = "getElementsByTagName", e = 0,
        ...
        c.pages = 0 | c.pages, c.curr = 0 | c.curr || 1,
            ...
            c.next = "next" in c ? c.next : "下一页",0
            c.groups > c.pages && (c.groups = c.pages),
            e.index = Math.ceil((c.curr + (c.groups > 1 && c.groups !== c.pages ? 1 : 0)) / (0 === c.groups ? 1 : c.groups)),
            c.curr > 1 && c.prev && d.push('<a href="javascript:;" class="laypage_prev" data-page="' + (c.curr - 1) + '">' + c.prev + "</a>"), e.index > 1 && c.first && 0 !== c.groups && d.push('<a href="javascript:;" class="laypage_first" data-page="1"  title="首页">' + c.first + "</a><span>…</span>"),
            e.poor = Math.floor((c.groups - 1) / 2),
            e.start = e.index > 1 ? c.curr - e.poor : 1, e.end = e.index > 1 ? function() {
       ...
       // this.re=this.config.re?this.config.re: this.re;
       // console.log(this.re);
